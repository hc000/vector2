 ...
 *
 */
function(){"use strict";function e(e){function t(t,n){var r={},o={};return t.backdrop="static",angular.extend(r,i,t),angular.extend(o,a,n),r.controller=["$scope","$uibModalInstance",function(e,t,i){e.customWidgetOptions=i,e.modalOptions=o,e.modalOptions.ok=function(e){t.close(e)},e.modalOptions.close=function(){t.dismiss("cancel")}}],e.open(r).result}var i={backdrop:!0,keyboard:!0,modalFade:!0,templateUrl:"app/components/modal/defaultModal.html"},a={closeButtonText:"Close",actionButtonText:"OK",headerText:"Proceed?",bodyText:"Perform this action?"};return{showModal:t}}e.$inject=["$uibModal"],angular.module("modal",[]).factory("ModalService",e)}(),/**!
 *
 *  Copyright 2016 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
function(){"use strict";function e(e,t,i,a,n,r,o,s,c,l){function d(e){var t=_.find(w,function(t){return t.name===e});return angular.isUndefined(t)?(t=new r(e),w.push(t)):t.subscribers++,t}function u(e){var t=_.find(w,function(t){return t.name===e});return angular.isUndefined(t)?(t=new o(e),w.push(t)):t.subscribers++,t}function p(e,t){var i=_.find(w,function(t){return t.name===e});return angular.isUndefined(i)?(i=new s(e,t),w.push(i)):i.subscribers++,i}function m(e,t){var i=_.find(w,function(t){return t.name===e});return angular.isUndefined(i)?(i=new c(e,t),w.push(i)):i.subscribers++,i}function g(e,t){var i=_.find(k,function(t){return t.name===e});return angular.isUndefined(i)?(i=new l(e,t),k.push(i)):i.subscribers++,i}function h(e){var t,i=_.find(w,function(t){return t.name===e});i.subscribers--,i.subscribers<1&&(t=w.indexOf(i),t>-1&&w.splice(t,1))}function v(e){var t,i=_.find(k,function(t){return t.name===e});i.subscribers--,i.subscribers<1&&(t=k.indexOf(i),t>-1&&k.splice(t,1))}function f(){angular.forEach(w,function(e){e.clearData()})}function y(){angular.forEach(k,function(e){e.clearData()})}function M(){return k}function b(){return w}var w=[],k=[];return{getOrCreateMetric:d,getOrCreateCumulativeMetric:u,getOrCreateConvertedMetric:p,getOrCreateCumulativeConvertedMetric:m,getOrCreateDerivedMetric:g,destroyMetric:h,destroyDerivedMetric:v,clearMetricList:f,clearDerivedMetricList:y,getSimpleMetricList:b,getDerivedMetricList:M}}e.$inject=["$rootScope","$http","$log","$q","PMAPIService","SimpleMetric","CumulativeMetric","ConvertedMetric","CumulativeConvertedMetric","DerivedMetric"],angular.module("metriclist",["pmapi","metric"]).factory("MetricListService",e)}(),/**!
 *
 *  Copyright 2016 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
function(){"use strict";function e(e,t,i,a,n,r,o,s,c,l){function d(){w&&i.cancel(w)}function u(t){t?k=0:(r.error("Failed fetching metrics. Trying again.","Error"),k+=1),k>5&&(d(w),k=0,e.properties.context="-1",e.flags.contextAvailable=!1,r.error("Consistently failed fetching metrics from host (>5). Please update the hostname to resume operation.","Error"))}function p(t){var i=[],a=[],n=e.properties.context,r=c.getSimpleMetricList();n&&n>0&&r.length>0&&(angular.forEach(r,function(e){angular.isDefined(e.pmid)&&null!==e.pmid?a.push(e.pmid):i.push(e.name)}),s.getMetrics(n,i,a).then(function(e){var t,i,a,n;if(e.values.length!==r.length){var o;angular.forEach(r,function(t){o=_.find(e.values,function(e){return e.name===t.name}),angular.isUndefined(o)&&t.clearData()})}angular.forEach(e.values,function(o){t=o.name,i=_.find(r,function(e){return e.name===t}),o.instances.length!==i.data.length&&i.deleteInvalidInstances(o.instances),angular.isDefined(i)&&null!==i&&(angular.isNumber(i.pmid)||(i.pmid=o.pmid),angular.forEach(o.instances,function(r){a=angular.isUndefined(r.instance)?1:r.instance,n=e.inames[t].inames[a],i.pushValue(e.timestamp,a,n,r.value)}))})}).then(function(){t(!0),e.$broadcast("updateMetrics")},function(e){400===e.status&&-1!==e.data.indexOf("-12376")&&f(),t(!1)}))}function m(){var t=c.getDerivedMetricList();t.length>0&&(angular.forEach(t,function(e){e.updateValues()}),e.$broadcast("updateDerivedMetrics"))}function g(){p(u),m()}function h(){d(w),e.properties.host&&(e.properties.context&&e.properties.context>0?w=i(g,1e3*parseInt(e.properties.interval)):r.error("Vector is not connected to the host. Please update the hostname to resume operation.","Error"))}function v(t){var i=null;t&&(i=t.match("(.*):([0-9]*)"),null!==i?(e.properties.host=i[1],e.properties.port=i[2]):e.properties.host=t)}function f(){e.flags.contextUpdating=!0,e.flags.contextAvailable=!1,s.getHostspecContext(e.properties.hostspec,600).then(function(t){e.flags.contextUpdating=!1,e.flags.contextAvailable=!0,e.properties.context=t,h(),s.getMetrics(t,["pmcd.hostname"]).then(function(t){e.properties.hostname=t.values[0].instances[0].value},function(){e.properties.hostname="Hostname not available.",a.error("Error fetching hostname.")}),s.getMetricsMetadata(t)},function(){r.error("Failed fetching context from host. Try updating the hostname.","Error"),e.flags.contextUpdating=!1,e.flags.contextAvailable=!1})}function y(t){n.search("host",t),n.search("hostspec",e.properties.hostspec),e.properties.context=-1,e.properties.hostname=null,e.properties.port=o.port,c.clearMetricList(),c.clearDerivedMetricList(),v(t),f()}function M(){e.properties?(e.properties.interval||(e.properties.interval=o.interval),e.properties.window||(e.properties.window=o.window),e.properties.protocol||(e.properties.protocol=o.protocol),e.properties.host||(e.properties.host=""),e.properties.hostspec||(e.properties.hostspec=o.hostspec),e.properties.port||(e.properties.port=o.port),!e.properties.context||e.properties.context<0?f():h()):e.properties={protocol:o.protocol,host:"",hostspec:o.hostspec,port:o.port,context:-1,hostname:null,window:o.window,interval:o.interval,containerFilter:"",containerList:[],selectedContainer:""},e.flags={contextAvailable:!1,contextUpdating:!1,isHostnameExpanded:o.expandHostname,enableContainerWidgets:o.enableContainerWidgets,disableHostspecInput:o.disableHostspecInput,disableContainerFilter:o.disableContainerFilter,disableContainerSelect:o.disableContainerSelect,containerSelectOverride:o.containerSelectOverride,disableContainerSelectNone:!1,disableHostnameInputContainerSelect:o.disableHostnameInputContainerSelect,enableCustomWidgetFeature:o.enableCustomWidgetFeature},o.enableContainerWidgets&&l.initialize()}function b(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}var w,k=0;return{cancelInterval:d,updateInterval:h,updateHost:y,updateContext:f,getGuid:b,initialize:M}}e.$inject=["$rootScope","$http","$interval","$log","$location","toastr","config","PMAPIService","MetricListService","ContainerMetadataService"],angular.module("dashboard",["pmapi","metriclist","containermetadata"]).factory("DashboardService",e)}(),/**!
 *
 *  Copyright 2015 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
function(){"use strict";function e(e){function t(t,n){var r={},o={};return t.backdrop="static",angular.extend(r,i,t),angular.extend(o,a,n),r.controller=["$scope","$uibModalInstance","widgetOptions",function(e,t,i){e.enableAdvOptions=!1,e.toggleAdv=function(){e.enableAdvOptions=!e.enableAdvOptions},e.enableUIOptions=!1,e.toggleUI=function(){e.enableUIOptions=!e.enableUIOptions},e.selected={name:"","text-oneline":""},e.advOptions={isCumulative:!1,isConverted:!1,forcey:"1",percentage:!1,area:!1,conversionFunc:"value/1024/1024"},e.UIOptions={width:"50%",height:"250px",enableVerticalResize:!1},e.updateCumulative=function(t){t?e.advOptions.isCumulative=!0:e.advOptions.isCumulative=!1},e.widgetOptions={},angular.extend(e.widgetOptions,i),e.modalOptions=o,e.modalOptions.ok=function(a){i.name=e.selected.name,i.title=e.selected.name,i.dataModelOptions.name=e.selected.name,e.advOptions.isCumulative?i.dataModelType="CumulativeMetricDataModel":i.dataModelType="MetricDataModel",e.enableAdvOptions&&(i.attrs={forcey:e.advOptions.forcey,integer:!e.advOptions.percentage,percentage:e.advOptions.percentage,area:e.advOptions.area},e.advOptions.isConverted&&(i.dataModelType="ConvertedMetricDataModel",i.dataModelOptions={name:e.selected.name,conversionFunction:e.advOptions.conversionFunc})),e.enableUIOptions&&(i.size={width:e.UIOptions.width,height:e.UIOptions.height},i.enableVerticalResize=e.UIOptions.enableVerticalResize),t.close(a)},e.modalOptions.close=function(){t.dismiss("cancel")}}],e.open(r).result}var i={backdrop:!0,keyboard:!0,modalFade:!0,templateUrl:"app/components/modal/defaultModal.html"},a={closeButtonText:"Close",actionButtonText:"OK",headerText:"Proceed?",bodyText:"Perform this action?"};return{showCustomWidgetModal:t}}e.$inject=["$uibModal"],angular.module("customwidget",[]).factory("CustomWidgetService",e)}(),/**!
 *
 *  Copyright 2016 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
function(){"use strict";function e(e,t,i,a,n,r,o,s,c,l){function d(e){return z[u(e)]}function u(e){return null===e?!1:(-1!==e.indexOf("docker/")?e=e.split("/")[2]:-1!==e.indexOf("/docker-")&&(e=e.split("-")[1].split(".")[0]),e)}function p(){z={}}function m(e){return angular.isDefined(z[u(e)])&&""!==z[u(e)]}function g(){f(),t.properties.containerList=y(),O?-1===t.properties.containerList.indexOf(n.container)&&(t.properties.selectedContainer=""):angular.isDefined(n.container)?-1!==t.properties.containerList.indexOf(n.container)&&(t.properties.selectedContainer=n.container,t.flags.disableContainerSelectNone=!0,O=!0):O=!0}function h(){x=l.getOrCreateMetric("containers.cgroup"),S=l.getOrCreateMetric("containers.name"),$=t.$on("updateMetrics",g)}function v(e){var t;return"undefined"==typeof C?!c.useCgroupId&&(t=_.find(S.data,function(t){return t.key===e}))?t.values[t.values.length-1].y:e.substring(0,12):(t=_.find(S.data,function(t){return t.key===e}),C.resolve(e,t))}function f(){z=x.data.reduce(function(e,t){return e[t.key]=v(t.key),e},{})}function y(){return x.data.reduce(function(e,t){var i=v(t.key);return angular.isDefined(i)&&e.push(i),e},[])}function M(e){return""===t.properties.containerFilter||-1!==e.indexOf(t.properties.containerFilter)}function b(e){return""===t.properties.selectedContainer||-1!==e.indexOf(t.properties.selectedContainer)}function w(){r.search("container",t.properties.selectedContainer),""!==t.properties.selectedContainer?t.flags.disableContainerSelectNone=!0:t.flags.disableContainerSelectNone=!1}function k(){r.search("containerFilter",t.properties.containerFilter)}var C,O=!1;try{C=o.get("containerNameResolver")}catch(D){s.debug("No external container name resolver defined.")}var x,S,$,z={};return{idDictionary:d,getContainerList:y,updateIdDictionary:f,clearIdDictionary:p,checkContainerFilter:M,containerIdExist:m,checkContainerName:b,updateContainer:w,updateContainerFilter:k,initialize:h}}e.$inject=["$http","$rootScope","$q","$interval","$routeParams","$location","$injector","$log","config","MetricListService"],angular.module("containermetadata",["metriclist"]).factory("ContainerMetadataService",e)}(),/**!
 *
 *  Copyright 2016 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
nv.models.tooltip=function(){"use strict";function e(){if(!u){var e=document.body;u=d3.select(e).append("div").attr("class","nvtooltip "+(s?s:"xy-tooltip")).attr("id",i),u.style("top",0).style("left",0),u.style("opacity",0),u.style("position","fixed"),u.selectAll("div, table, td, tr").classed(v,!0),u.classed(v,!0)}}function t(){return m&&k(a)?(nv.dom.write(function(){e();var t=w(a);t&&(u.node().innerHTML=t),O()}),t):void 0}var i="nvtooltip-"+Math.floor(1e5*Math.random()),a=null,n="w",r=25,o=0,s=null,c=null,l=!0,d=200,u=null,p={left:null,top:null},m=!0,g=100,h=!0,v="nv-pointer-events-none",f=function(){return{left:d3.event.clientX,top:d3.event.clientY}},y=function(e){return e},M=function(e){return e},b=function(e){return e},w=function(e){if(null===e)return"";var t=d3.select(document.createElement("table"));if(h){var i=t.selectAll("thead").data([e]).enter().append("thead");i.append("tr").append("td").attr("colspan",3).append("strong").classed("x-value",!0).html(M(e.value))}var a=t.selectAll("tbody").data([e]).enter().append("tbody"),n=a.selectAll("tr").data(function(e){return e.series}).enter().append("tr").classed("highlight",function(e){return e.highlight});n.append("td").classed("legend-color-guide",!0).append("div").style("background-color",function(e){return e.color}),n.append("td").classed("key",!0).classed("total",function(e){return!!e.total}).html(function(e,t){return b(e.key,t)}),n.append("td").classed("value",!0).html(function(e,t){return y(e.value,t)}),n.selectAll("td").each(function(e){if(e.highlight){var t=d3.scale.linear().domain([0,1]).range(["#fff",e.color]),i=.6;d3.select(this).style("border-bottom-color",t(i)).style("border-top-color",t(i))}});var r=t.node().outerHTML;return void 0!==e.footer&&(r+='<div class="footer">'+e.footer+"</div>"),r},k=function(e){if(e&&e.series){if(e.series instanceof Array)return!!e.series.length;if(e.series instanceof Object)return e.series=[e.series],!0}return!1},C=function(e){var t,i,a,o=u.node().offsetHeight,s=u.node().offsetWidth,c=document.documentElement.clientWidth,l=document.documentElement.clientHeight;switch(n){case"e":t=-s-r,i=-(o/2),e.left+t<0&&(t=r),(a=e.top+i)<0&&(i-=a),(a=e.top+i+o)>l&&(i-=a-l);break;case"w":t=r,i=-(o/2),e.left+t+s>c&&(t=-s-r),(a=e.top+i)<0&&(i-=a),(a=e.top+i+o)>l&&(i-=a-l);break;case"n":t=-(s/2)-5,i=r,e.top+i+o>l&&(i=-o-r),(a=e.left+t)<0&&(t-=a),(a=e.left+t+s)>c&&(t-=a-c);break;case"s":t=-(s/2),i=-o-r,e.top+i<0&&(i=r),(a=e.left+t)<0&&(t-=a),(a=e.left+t+s)>c&&(t-=a-c);break;case"center":t=-(s/2),i=-(o/2);break;default:t=0,i=0}return{left:t,top:i}},O=function(){nv.dom.read(function(){var e=f(),t=C(e),i=e.left+t.left,a=e.top+t.top;if(l)u.interrupt().transition().delay(d).duration(0).style("opacity",0);else{var n="translate("+p.left+"px, "+p.top+"px)",r="translate("+i+"px, "+a+"px)",o=d3.interpolateString(n,r),s=u.style("opacity")<.1;u.interrupt().transition().duration(s?0:g).styleTween("transform",function(){return o},"important").styleTween("-webkit-transform",function(){return o}).style("-ms-transform",r).style("opacity",1)}p.left=i,p.top=a})};return t.nvPointerEventsClass=v,t.options=nv.utils.optionsFunc.bind(t),t._options=Object.create({},{duration:{get:function(){return g},set:function(e){g=e}},gravity:{get:function(){return n},set:function(e){n=e}},distance:{get:function(){return r},set:function(e){r=e}},snapDistance:{get:function(){return o},set:function(e){o=e}},classes:{get:function(){return s},set:function(e){s=e}},chartContainer:{get:function(){return c},set:function(e){c=e}},enabled:{get:function(){return m},set:function(e){m=e}},hideDelay:{get:function(){return d},set:function(e){d=e}},contentGenerator:{get:function(){return w},set:function(e){w=e}},valueFormatter:{get:function(){return y},set:function(e){y=e}},headerFormatter:{get:function(){return M},set:function(e){M=e}},keyFormatter:{get:function(){return b},set:function(e){b=e}},headerEnabled:{get:function(){return h},set:function(e){h=e}},position:{get:function(){return f},set:function(e){f=e}},hidden:{get:function(){return l},set:function(e){l!==e&&(l=!!e,t())}},data:{get:function(){return a},set:function(e){e.point&&(e.value=e.point.x,e.series=e.series||{},e.series.value=e.point.y,e.series.color=e.point.color||e.series.color),a=e}},node:{get:function(){return u.node()},set:function(){}},id:{get:function(){return i},set:function(){}}}),nv.utils.initOptions(t),t},/**!
 *
 *  Copyright 2016 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
function(){"use strict";function MainCtrl($document,$rootScope,$log,$route,$routeParams,$location,$timeout,widgetDefinitions,widgets,embed,version,DashboardService,ContainerMetadataService,ModalService,CustomWidgetService){function visibilityChanged(){$document[0].hidden||$document[0].webkitHidden||$document[0].mozHidden||$document[0].msHidden?DashboardService.cancelInterval():DashboardService.updateInterval()}function activate(){if(DashboardService.initialize(),$routeParams.protocol&&($rootScope.properties.protocol=$routeParams.protocol),$routeParams.host&&(vm.inputHost=$routeParams.host,$routeParams.hostspec&&($rootScope.properties.hostspec=$routeParams.hostspec),DashboardService.updateHost(vm.inputHost)),$document[0].addEventListener("visibilitychange",visibilityChanged,!1),$document[0].addEventListener("webkitvisibilitychange",visibilityChanged,!1),$document[0].addEventListener("msvisibilitychange",visibilityChanged,!1),$document[0].addEventListener("mozvisibilitychange",visibilityChanged,!1),angular.isDefined($routeParams.widgets)){var e=$routeParams.widgets.split(",")||[];widgetsToLoad=e.reduce(function(e,t){return e.concat(widgetDefinitions.filter(function(e){return e.name===t}))},[])}else{var t=widgets.reduce(function(e,t){return e.push(t.name),e},[]).join();$location.search("widgets",t)}angular.isDefined($routeParams.containerFilter)&&($rootScope.properties.containerFilter=$routeParams.containerFilter),vm.dashboardOptions={hideToolbar:!0,widgetButtons:!1,hideWidgetName:!0,hideWidgetSettings:!1,widgetDefinitions:widgetDefinitions,defaultWidgets:widgetsToLoad}}var vm=this,widgetsToLoad=widgets;vm.version=version.id,vm.embed=embed,vm.addWidgetToURL=function(e){var t="";angular.isUndefined($routeParams.widgets)?$routeParams.widgets="":t=",",e.length?($routeParams.widgets="",t=e.reduce(function(e,t){return e.push(t.name),e},[]).join()):t+=e.name,$location.search("widgets",$routeParams.widgets+t)},vm.removeWidgetFromURL=function(e){for(var t=$routeParams.widgets.split(",")||[],i=0;i<t.length;i++)if(t[i]===e.name){t.splice(i,1);break}t.length<1?vm.removeAllWidgetFromURL():$location.search("widgets",t.toString())},vm.removeAllWidgetFromURL=function(){$location.search("widgets",null)},vm.resetDashboard=function(){var e={closeButtonText:"Cancel",actionButtonText:"Ok",headerText:"Reset Dashboard",bodyText:"Are you sure you want to reset the dashboard?"};ModalService.showModal({},e).then(function(){$location.search("container",null),$location.search("containerFilter",null),$rootScope.flags.disableContainerSelectNone=!1,$rootScope.properties.selectedContainer="",$rootScope.properties.containerFilter="",vm.dashboardOptions.loadWidgets([]),vm.removeAllWidgetFromURL()})},vm.updateHost=function(){DashboardService.updateHost(vm.inputHost),ContainerMetadataService.clearIdDictionary()},vm.addWidget=function(e,t){e.preventDefault(),vm.checkWidgetType(t)&&(vm.dashboardOptions.addWidget(t),vm.addWidgetToURL(t))},vm.checkWidgetType=function(e){if(angular.isDefined(e.requireContainerFilter)&&e.requireContainerFilter===!0&&$rootScope.flags.disableContainerSelect===!1&&!$rootScope.flags.containerSelectOverride&&""===$rootScope.properties.selectedContainer){var t={closeButtonText:"",actionButtonText:"Ok",headerText:"Error: Container selection required.",bodyText:"This widget requires a container to be selected. Please select a container and try again."};return ModalService.showModal({},t).then(function(){$document.getElementById("selectedContainer").focus()}),!1}return!0},vm.reload=!1,vm.openCustomWidgetModal=function(){var customWidgetModal={backdrop:!0,keyboard:!0,modalFade:!0,templateUrl:"app/components/customWidget/customWidgetModal.html",resolve:{widgetOptions:function(){return vm.customWidgetOptions}}};CustomWidgetService.showCustomWidgetModal(customWidgetModal,{}).then(function(){var widget={name:vm.customWidgetOptions.name,title:vm.customWidgetOptions.title,directive:"line-time-series",dataAttrName:"data",dataModelType:vm.customWidgetOptions.dataModelType,dataModelOptions:{name:vm.customWidgetOptions.dataModelOptions.name},size:{width:"50%",height:"250px"},enableVerticalResize:!1,group:"Custom"};if(void 0!=vm.customWidgetOptions.attrs&&(widget.attrs={forcey:parseInt(vm.customWidgetOptions.attrs.forcey),integer:vm.customWidgetOptions.attrs.integer,percentage:vm.customWidgetOptions.attrs.percentage,area:vm.customWidgetOptions.attrs.area}),void 0!=vm.customWidgetOptions.size&&(widget.size={width:vm.customWidgetOptions.size.width,height:vm.customWidgetOptions.size.height}),void 0!=vm.customWidgetOptions.enableVerticalResize&&(widget.enableVerticalResize=vm.customWidgetOptions.enableVerticalResize),"ConvertedMetricDataModel"==vm.customWidgetOptions.dataModelType){var pstring=vm.customWidgetOptions.dataModelOptions.conversionFunction;widget.dataModelOptions={name:vm.customWidgetOptions.dataModelOptions.name,conversionFunction:function(value){var return_var=value/eval(pstring.substr(6));return return_var}}}widgetDefinitions.push(widget),widgetsToLoad.push(widget),vm.reload=!0,$timeout(function(){vm.reload=!1},100)})},vm.customWidgetOptions={name:"",title:"",directive:"line-time-series",dataAttrName:"data",dataModelType:"MetricDataModel",dataModelOptions:{name:""},size:{width:"50%",height:"250px"},enableVerticalResize:!1,group:"Custom"},vm.updateInterval=DashboardService.updateInterval,vm.updateContainer=ContainerMetadataService.updateContainer,vm.updateContainerFilter=ContainerMetadataService.updateContainerFilter,vm.inputHost="",activate()}MainCtrl.$inject=["$document","$rootScope","$log","$route","$routeParams","$location","$timeout","widgetDefinitions","widgets","embed","version","DashboardService","ContainerMetadataService","ModalService","CustomWidgetService"],angular.module("main",["dashboard","widget","containermetadata","customwidget","modal"]).controller("MainController",MainCtrl)}(),/**!
 *
 *  Copyright 2015 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
 ...
 *
 */
function(){"use strict";angular.module("vector",["ngRoute","ui.dashboard","toastr","main"])}(),function(){"use strict";angular.module("vector").constant("version",{id:"v1.1.2-30-gd3b4967"})}(),/**!
 *
 *  Copyright 2015 Netflix, Inc.
 *
 *     Licensed under the Apache License, Version 2.0 (the "License");
